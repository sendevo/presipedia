        ...
        <Box marginTop={"10px"} textAlign={"justify"}>                     
            <TextBlock title="Descripción">
                ...
                <ul style={ulStyle}>
                    ...
                    <li><Link to='/games/candidate'>Presidenciómetro</Link>: este juego le solicita al usuario que complete una serie de datos sobre un candidato hipotético, por ejemplo: nombre, género, ocupación, lugar y fecha de nacimiento y tendencia política. Luego, <b>{APP_NAME}</b> comparará cada uno de los datos provistos con el correspondiente valor de frecuencia relativa que se computa de la lista de expresidentes para sugerir un valor de "probabilidad" de que el candidato cuyos datos se completaron en el formulario, se convierta en el próximo presidente. Tal como se aclara en la presentación de los resultados, debe tenerse en cuenta que la información que arroja la aplicación, en esta sección de entretenimiento en particular, es completamente ficticia y no posee ningún sustento de carácter científico, ya que la veracidad de las suposiciones realizadas al efectuar el cálculo del resultado no está validada. Recuerde que la intención de este juego es lograr el entretenimiento del usuario y no debiera emplearse para generar polémica de ningún tipo.</li>
                </ul>
            </TextBlock>
