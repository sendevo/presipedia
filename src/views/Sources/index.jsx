        ...
        <MainView title="Fuentes de información" background={background}>
            <Box textAlign={"justify"}>
                ...
                <TextBlock title="Blog">
                    Para la redacción de los artículos del blog se emplearon diversas fuentes que se listan al pie de cada uno. A continuación se reúnen todos los enlaces visitados:
                    <ul>
                        {
                            blog.map(article => (
                                article.sources.map((source,index) => (
                                    <li key={article.title+index} style={sourceItemStyle}>
                ...
                <TextBlock title="Imágenes de rostros presidenciales">
                    Las fotografías o retratos de los rostros de presidentes que se muestran en <b>{APP_NAME}</b> fueron extraidos de los respectivos artículos de <a href="https://es.wikipedia.org" rel="noopener" target="_blank">Wikipedia</a>, teniendo en cuenta, para cada caso, que sean de dominio público.
                </TextBlock>
                <TextBlock title="Imágenes de fondo">
                    Las imágenes de fondo de cada una de las vistas corresponden a distintos símbolos y monumentos históricos de la República Argentina. Estas fotografías fueron extraidas de los respectivos artículos de <a href="https://es.wikipedia.org" rel="noopener" target="_blank">Wikipedia</a>, teniendo en cuenta, para cada caso, que sean de dominio público.
                </TextBlock>
            </Box>
        </MainView>
    );
